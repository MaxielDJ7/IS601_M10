...
Base = declarative_base() # Tells SQLAlchemy to treat this class as a database model
...
class User(Base):
    """Defines the User database model, authentication logic
    , password hashing, and JWT token creation/verification."""

    __tablename__ = 'users'

    # Users table columns in PostgreSQL
